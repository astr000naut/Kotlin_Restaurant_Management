...
class QL_BpDishRecyclerViewAdapter : ListAdapter<BP_Dish, QL_BpDishRecyclerViewAdapter.BillItemViewHolder>(
    QL_BPDishDiffItemCallback()
) {
    ...
    class BillItemViewHolder(val rootView: CardView): RecyclerView.ViewHolder(rootView) {
        ...
        companion object {
            fun inflateFrom(parent: ViewGroup): BillItemViewHolder {
                ...
                val view = layoutInflater.inflate(R.layout.ql_item_danhsachmon, parent, false) as CardView
